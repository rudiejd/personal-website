...
export const Home = () => {
    return <React.Fragment>
        <Container className="content-center mt-5">
            ...
            at miami university in ohio. i am finishing my degree in mathematics while
            simultaneously working towards a masters' degree in computer science.</p>
            
            <p class="display-5">my research is mainly centered around distributed systems, where i am aiming
            ...
            novel new software, and testing said software for functionality, readability, and compliance.</p>
